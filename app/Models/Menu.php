...
use AP\Models\Article as Article;
use AP\Models\Page as Page;
use AP\Models\News as News;
use AP\Models\PhotoGallery as PhotoGallery;
use AP\Repositories\Article\ArticleRepository as ArticleRepository;
use AP\Repositories\Page\PageRepository as PageRepository;
use AP\Repositories\News\NewsRepository as NewsRepository;
use AP\Repositories\PhotoGallery\PhotoGalleryRepository as PhotoGalleryRepository;
...
class Menu extends Model {
    ...
    public function getMenuOptions() {
        ...
        foreach($photoGalleryOpts as $k => $v) {
            $opts['PhotoGallery']['AP\Models\PhotoGallery-' . $k] = $v;
        }
