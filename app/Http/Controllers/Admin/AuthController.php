    ...
    public function postForgotPassword() {
        ...
        try {
            ...
            Mail::send('emails.auth.reset-password', $formData, function ($message) {
                ...
                $message->from('noreply@fullycms.com', 'Grace Management Console Team');
        ...
        try {
            ...
            if ($this->user->checkResetPasswordCode($formData['code'])) {
                ...
                if ($this->user->attemptResetPassword($formData['code'], $formData['password'])) {
                    ...
                    return Redirect::action('AP\Controllers\Admin\AuthController@getResetPassword')->withErrors(array('forgot-password' => 'Password reset failed'));
                }
            } else {
                // The provided password reset code is Invalid
                return Redirect::action('AP\Controllers\Admin\AuthController@getResetPassword')->withErrors(array('forgot-password' => 'The provided password reset code is Invalid'));
            }
        } catch (Cartalyst\Sentry\Users\UserNotFoundException $e) {
