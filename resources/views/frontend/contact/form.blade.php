            ...
            <div class="row">
                <div class="col-sm-5">
                    ...
                    <div class="control-group {!! $errors->has('sender_name_surname') ? 'has-error' : '' !!}">
                        ...
                        <div class="form-group">
                            {!! Form::text('sender_name_surname', null, array('class'=>'form-control', 'id' => 'sender_name_surname', 'placeholder'=>trans('ap.name_and_surname'), 'value'=>Input::old('sender_name_surname'))) !!}
                    ...
                    <div class="control-group {!! $errors->has('sender_email') ? 'has-error' : '' !!}">
                        ...
                        <div class="form-group">
                            {!! Form::text('sender_email', null, array('class'=>'form-control', 'id' => 'sender_email', 'placeholder'=>trans('ap.email'), 'value'=>Input::old('sender_email'))) !!}
                    ...
                    <div class="control-group {!! $errors->has('sender_phone_number') ? 'has-error' : '' !!}">
                        ...
                        <div class="form-group">
                            {!! Form::text('sender_phone_number', null, array('class'=>'form-control', 'id' => 'sender_phone_number', 'placeholder'=>trans('ap.phone_number'), 'value'=>Input::old('sender_phone_number'))) !!}
                    ...
                    <div class="control-group {!! $errors->has('subject') ? 'has-error' : '' !!}">
                        ...
                        <div class="form-group">
                            {!! Form::text('subject', null, array('class'=>'form-control', 'id' => 'subject', 'placeholder'=>trans('ap.subject'), 'value'=>Input::old('subject'))) !!}
                    ...
                    {!! Form::submit(trans('ap.button_send'), array('class' => 'btn btn-info')) !!}
                </div>
                ...
                <div class="col-sm-7">
                    <div class="control-group {!! $errors->has('post') ? 'has-error' : '' !!}">
                        ...
                        <div class="form-group">
                            {!! Form::textarea('message', null, array('class'=>'form-control', 'id' => 'message-content', 'placeholder'=>trans('ap.message'), 'value'=>Input::old('message'), 'rows'=>8)) !!}
