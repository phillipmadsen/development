    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3 col-sm-6">
                ...
                <h4>{!!  trans('ap.newsletter') !!}</h4>

                {!! Form::open(array('route' => 'frontend.maillist.post', 'id'=>'newsletterForm', 'novalidate'=>'novalidate')) !!}
                <div class="input-group">
                    <input type="text" class="form-control" autocomplete="off" placeholder="{!!  trans('ap.enter_your_email') !!}">
                    <span class="input-group-btn">
                        <button class="btn btn-danger" type="submit">{!!  trans('ap.button_save') !!}</button>
                    </span>
                </div>
                {!! Form::close() !!}
            </div>
...
<footer id="footer" class="midnight-blue">
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-4">
                &copy; 2015 <a target="_blank" href="http://www.sefakaragoz.com">Sefa Karagöz</a> {!! trans('ap.all_rights_reserved') !!}.
                <br>
                <br>
